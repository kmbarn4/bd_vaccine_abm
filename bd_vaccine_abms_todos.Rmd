...
-investigate: 
    -when tadpoles with bd metamorphose, they have an spn = 100 rather than spn of myself
    -what is the purpose of smax in tadpoles?
          -preventing unrealistic runaway infections
          -smax can be proportional to adult smax (may be proportional and may not be)
          -smax on metamorphs is virulence, but smax on tadpoles can be a space limitation of mouthparts (s_k for carrying                 capacity)
          -because they function differently/representing different processes, then they can be named different things
