...
;  random-seed behaviorspace-run-number
  ...
  if ticks = vaccination-day [
    ...
    if bd = 0 [
    set imm v-efficacy - (0.5 * relative_variation * v-efficacy) + random-float (relative_variation * v-efficacy)
...
<experiments>
  ...
  <experiment name="562smax_meta_pop_size_with_and_without_bd4" repetitions="25" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="90"/>
    <metric>count metamorphs</metric>
  ...
  <experiment name="8.25.22_abm" repetitions="25" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="90"/>
    <metric>count metamorphs</metric>
  ...
  <experiment name="september_abm-c_clear" repetitions="25" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="90"/>
    <metric>count metamorphs</metric>
  ...
  <experiment name="september_abm_baseline_clear" repetitions="25" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="90"/>
    <metric>count metamorphs</metric>
  ...
  <experiment name="september_abm-c_smax" repetitions="25" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="90"/>
    <metric>count metamorphs</metric>
  ...
  <experiment name="september_abm-c_shedding" repetitions="25" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="90"/>
    <metric>count metamorphs</metric>
  ...
  <experiment name="vaccine_timing_est" repetitions="30" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="90"/>
    <metric>count metamorphs</metric>
  ...
  <experiment name="vaccine_timing_shedding" repetitions="30" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="90"/>
    <metric>count metamorphs</metric>
  ...
  <experiment name="vaccine_timing_smax" repetitions="30" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="90"/>
    <metric>count metamorphs</metric>
  ...
  <experiment name="vaccine_timing_clearance" repetitions="30" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="90"/>
    <metric>count metamorphs</metric>
  ...
  <experiment name="prev_over_time" repetitions="25" sequentialRunOrder="false" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="90"/>
    <metric>count turtles with [bd = 1]/ (count turtles)</metric>
    <enumeratedValueSet variable="SimplePond">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="last-day">
  ...
  <experiment name="no_bd" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="90"/>
    <metric>count metamorphs</metric>
  ...
  <experiment name="shedding_vs_clearance" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="90"/>
    <metric>count metamorphs</metric>
  ...
  <experiment name="multiple_modes" repetitions="30" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="90"/>
    <metric>count metamorphs</metric>
